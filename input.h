...
private:
    ...
    bool NUMLK1 = false; //N1
    bool NUMLK2 = false; //N2
    bool NUMLK3 = false; //N3
    bool NUMLK4 = false; //N4
    bool NUMLK5 = false; //N5
    bool NUMLK6 = false; //N6
    bool NUMLK7 = false; //N7
    bool NUMLK8 = false; //N8
    bool NUMLK9 = false; //N9
...
public:
    ...
    bool NUMLK1ispressed();  //N1
    bool NUMLK2ispressed();  //N2
    bool NUMLK3ispressed();  //N3
    bool NUMLK4ispressed();  //N4
    bool NUMLK5ispressed();  //N5
    bool NUMLK6ispressed();  //N6
    bool NUMLK7ispressed();  //N7
    bool NUMLK8ispressed();  //N8
    bool NUMLK9ispressed();  //N9
